...
Object.deepExtend = function(t, e) {
    ...
    function(t) {
        var e, i, o = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
            n = ["#4dc9f6", "#f67019", "#f53794", "#537bc4", "#acc236", "#166a8f", "#00a950", "#58595b", "#8549ba"],
            s = t.Samples || (t.Samples = {}),
            a = t.Color;
        s.utils = {
            srand: function(t) {
                this._seed = t
            ...
            numbers: function(t) {
                for (var e, i = t || {}, n = i.min || 0, s = i.max || 1, a = i.from || [], o = i.count || 8, t = i.decimals || 8, r = i.continuity || 1, l = Math.pow(10, t) || 0, c = [], d = 0; d < o; ++d) e = (a[d] || 0) + this.rand(n, s), this.rand() <= r ? c.push(Math.round(l * e) / l) : c.push(null);
                return c
            },
            labels: function(t) {
                for (var e = t || {}, i = e.min || 0, n = e.max || 100, s = (n - i) / (e.count || 8), t = e.decimals || 8, a = Math.pow(10, t) || 0, o = e.prefix || "", r = [], l = i; l < n; l += s) r.push(o + Math.round(a * l) / a);
                return r
            },
            months: function(t) {
                for (var e, t = t || {}, i = t.count || 12, n = t.section, s = [], a = 0; a < i; ++a) e = o[Math.ceil(a) % 12], s.push(e.substring(0, n));
                return s
            },
            color: function(t) {
                return n[t % n.length]
            ...
            return Math.round(s.utils.rand(-100, 100))
        }, s.utils.srand(Date.now()), document.location.hostname.match(/^(www\.)?chartjs\.org$/) && (e = window, i = document, e.GoogleAnalyticsObject = "ga", e.ga = e.ga || function() {
            (e.ga.q = e.ga.q || []).push(arguments)
        }, e.ga.l = +new Date, t = i.createElement("script"), i = i.getElementsByTagName("script")[0], t.async = 1, t.src = "//www.google-analytics.com/analytics.js", i.parentNode.insertBefore(t, i), ga("create", "UA-28909194-3", "auto"), ga("send", "pageview"))
    }(this),
    function() {
        "use strict";
